 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya Khurushi BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 Khurushi - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 Khurushi - BOT..."},
	]
    },{
...
const listMessage = {
  text: tek,
  footer: '© KHURUSHI BOTZ | ALL RESERVED',
...
*/
	...
	return conn.sendButton(m.chat, '.', text, img2, [["SEWA BOT", _p + "sewabot"], ["SCRIPT", _p + "sc"], ["OWNER", _p + "owner"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: "https://instagram.com/riellganz?igshid=YmMyMTA2M2Y=",
                mediaType: "VIDEO",
                title: `Hallo ${name} ${ucpn}`,
                body: 'Source Code by RiellXd',
                previewType: 0,
                thumbnail: img
            }
        }
